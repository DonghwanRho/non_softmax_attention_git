...
class ScaledSinosoidal(SinusoidalPositional):
    ...
    def __init__(self, embedding_dim, max_seq_length):
        ...
        # print('ScaledSinosoidal init', self.scale_factor.shape)
    ...
    def forward(self, input_ids):
        ...
        # print('self.scale_factor * self.pe[:, : input_ids.shape[1], :]', (self.scale_factor * self.pe[:, : input_ids.shape[1], :]).shape)
